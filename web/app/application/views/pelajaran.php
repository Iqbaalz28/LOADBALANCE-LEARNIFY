...
<section class="courses_area p_40">
    <div class="container">
        <div class="main_title">
            ...
            <p data-aos="fade-up" data-aos-duration="1800">Selamat datang di Learnify, sarana untuk berkolaborasi penyelenggaraan dengan optimalisasi Teknologi Informasi dan Komunikasi (TIK). Learnify memberikan pembelajaran dimana para siswa dapat belajar dimana saja dan kapan saja.</p>
        </div>
        <div class="row courses_inner">
                ...
                <div class="grid_inner">
                    <div class="grid_item wd55">
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            <img src="<?= base_url('assets/') ?>img/courses/IaaS.png" alt="">
                            <div class="hover_text">
                                <a class="cat" href="#">Gratis</a>
                                <a href="javaScript:void(0);">
                                    <h4>Infrastucture as a Service</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i>54</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i>Rudi Haryadi, ST., M.Pd</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i>Adi Setiadi, ST</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="grid_item wd44">
                        <div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
                            <img src="<?= base_url('assets/') ?>img/courses/SaaS.jpg" alt="">
                            <div class="hover_text">
                                <a class="cat" href="#">Gratis</a>
                                <a href="javaScript:void(0);">
                                ...
                                <ul class="list">
                                    ...
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i>Maya Yashbir Munfi'ah, ST</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div class="grid_item wd55">
                        <div class="courses_item" data-aos="fade-up" data-aos-duration="1800">
                            ...
                            <div class="hover_text">
                                <a class="cat" href="#">Gratis</a>
                                <a href="javaScript:void(0);">
                                    <h4>System Internet of Things</h4>
                                </a>
                                <ul class="list">
                                    <li><a href="#"><i class="lnr lnr-users"></i> 24</a></li>
                                    <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                                    <li><a href="#"><i class="lnr lnr-user"></i>Antoni Budiman, S.Pd., M.Pd</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
            ...
            <div class="col-lg-3">
                <div class="course_item" data-aos="fade-left" data-aos-duration="1800">
                    <img src="<?= base_url('assets/') ?>img/courses/SKJ.jpg" alt="">
                    <div class="hover_text">
                        <a class="cat" href="#">Gratis</a>
                        <a href="javaScript:void(0);">
                        ...
                        <ul class="list">
                            ...
                            <li><a href="#"><i class="lnr lnr-bubble"></i> 0</a></li>
                            <li><a href="#"><i class="lnr lnr-user"></i>Antoni Budiman, S.Pd., M.Pd</a></li>
                        </ul>
                    </div>
                </div>
            </div>
