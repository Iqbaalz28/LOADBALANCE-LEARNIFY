...
<body>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text"> Saatnya memberikan lebih kepada peserta dengan menambahkan materi pembelajaran pada LMS. Dengan ini, kamu akan menunjukkan komitmenmu untuk memberikan nilai tambah yang nyata dalam proses belajar mereka.
                                </p>
                                ...
                                <div id="" class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <select class="form-control selectric" name="mapel">
                                            <option>Infrastructure as a Service</option>
                                            <option>Platform as a Service</option>
                                            <option>Cyber Security</option>
                                            <option>Software as Service</option>
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2020 <div class="bullet"></div><a href="https://www.instagram.com/iqbaalz28_/">Iqbal Rizky Maulana</a>
        </div>
    </footer>
    <!-- End Footer -->
