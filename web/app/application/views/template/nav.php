            ...
            <div class="container">
                <div class="float-left">
                    <ul class="list header_social">
                        <li><a href="https://www.facebook.com/SMKN1Cimahi"><i class="fa fa-facebook"></i></a></li>
                        <li><a href="https://www.instagram.com/smkn1cmi/"><i class="fa fa-instagram"></i></a></li>
                    </ul>
                </div>
                <div class="float-right">
                    <a class="dn_btn" href="mailto:info@smkn1-cmi.sch.id">info@smkn1-cmi.sch.id</a>
                </div>
            </div>
        </div>
