    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="<?= base_url('welcome/pelajaran') ?>">Pelajaran Learnify</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Learnify</a></li>
                        <li><a href="https://www.smkn1-cmi.sch.id/">Website Resmi Sekolah</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="javaScript:void(0);">Infrastructure as a Service</a></li>
                        <li><a href="javaScript:void(0);">Platform as a Service</a></li>
                        <li><a href="javaScript:void(0);">Software as a Service</a></li>
                        <li><a href="javaScript:void(0);">System Internet of Things</a></li>
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                </script> All rights reserved | With MIT License
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.facebook.com/SMKN1Cimahi"><i class="fa fa-facebook"></i></a>
                <a href="https://www.instagram.com/smkn1cmi/"><i class="fa fa-instagram"></i></a>
            </div>
        </div>
    </div>
</footer>
