...
<body style="overflow-x:hidden;background-color:#fbf9fa">
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/iaas_xii') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/IaaS.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/paas_xii') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/PaaS.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?= base_url('materi/saas_xii') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/SaaS.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
        </div>
    ...
    <div class="container">
        <div class="row mt-4 mb-5">
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-right">
                <a href="<?= base_url('materi/skj_xii') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/Cyber.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-down">
                <a href="<?= base_url('materi/iot_xii') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/IoT.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
            <div class="col-md-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                <a href="<?= base_url('user') ?>">
                    <div class="card-kelas">
                        <img src="<?= base_url('assets/') ?>img/Back.png" class="card-img-top" alt="...">
                    </div>
                </a>
            </div>
        </div>
