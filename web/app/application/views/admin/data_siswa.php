                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <hr>
                            <p class="card-text">Jangan sia-siakan potensi belajarmu! Dengan menambahkan materi pembelajaran pada LMS, kamu bisa meraih untung besar dalam perjalanan pendidikanmu</p>
