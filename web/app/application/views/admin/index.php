        ...
        <div class="main-wrapper">
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Masa depan pendidikan ada di tanganmu. Dengan meningkatkan LMS melalui materi pembelajaran yang relevan dan berkualitas, kamu dapat memimpin dan meraih keuntungan di era pendidikan yang terus berkembang.</p>
                        ...
                        <div class="hero text-white hero-bg-image" data-background="<?= base_url('assets/') ?>stisla-assets/img/unsplash/eberhard-grossgasteiger-1207565-unsplash.jpg">
                            <div class=" hero-inner">
                                <h1>Selamat Datang, <?php
                                                    ...
                                                    echo $data['user']['username'];
                                                    ?>!</h1>
                                <p class="lead">Selamat datang, Admin! Anda adalah garda terdepan dalam mengelola dan mempertahankan sistem ini. Terima kasih atas dedikasi Anda dalam menjaga kelancaran dan kesuksesan platform ini.</p>
                                <div class="mt-4">
            ...
            <footer class="main-footer">
                <div class="text-center">
                    Copyright &copy; 2023 <div class="bullet"></div><a href="https://www.instagram.com/iqbaalz28_/">Iqbal Rizky Maulana</a>
                </div>
            </footer>
            <!-- End Footer -->
